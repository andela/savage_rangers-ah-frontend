    ...
    return (
      <div className="">
        ...
        <div className="container forgotPassword__container">
          ...
          {state.error ? (
            <Alert type="danger" message={errorMessage} cssClass="alert-forgot-password" />
          ) : (
            ''
          )}
          <div className="row">
            <div className="col-sm-12 col-md-10">
              <div className="forgotPassword">
                <div className="forgotPassword__header justify-content-center">
                  <h1 className="forgotPassword__header--text">Password Reset</h1>
                </div>
                <form onSubmit={this.onSubmit} className="container forgotPassword__form">
                  <div className="form-group">
                    ...
                    />
                    {this.validator.message('email', state.email, 'required|email', { className: 'field-alert text-danger' })}
                  </div>
                  <button type="submit" className="btn forgotPassword__form--btn">
                    Send
                  </button>
                </form>
              </div>
