...
const CommentIcons = ({
  ...
  if (reactionCount) {
    reactionCount = reactionCount.length === 1
      ? reactionCount
      : [
        {
      ...
      {reactionCount && reactionCount.length > 0 ? (
        reactionCount.map(item => (
          <div key={item.dislikes}>
            <button
              className="comment-icons__dislike-comment"
              type="button"
              title="dislike"
              onClick={() => commentReaction('dislikes', id)}
            >
            ...
            <button
              className="comment-icons__dislike-comment ml-2"
              title="like"
              onClick={() => commentReaction('likes', id)}
              type="button"
            >
        ...
        <div className="modal-dialog modal-dialog-centered" role="document">
          <div className="modal-content">
            <div className="modal-header" style={{ textAlign: 'center' }}>
              <h5 className="modal-title" id="reasonModalTitle" style={{ fontSize: '24px' }}>
                Report Reasons
              </h5>
              ...
              <div className="radio">
                <label>
                  <input
                    ...
                    style={{ margin: '5px' }}
                    value="1"
                    onClick={({ target }) => setReasonId(target.value)}
                  />
            ...
            <div className="modal-footer">
              ...
              <button
                ...
                onClick={() => reportComment(slug, id, commentReason)}
              >
                Report
              </button>
            </div>
