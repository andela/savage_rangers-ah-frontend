...
class Article extends Component {
  render() {
    ...
    const {
      body, title, coverImage, createdAt
    } = data;
    ...
    const defaultProImage = 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png';
    ...
    const names = firstName === null ? username : firstName;
    // console.log(data);
    return (
      <React.Fragment>
          ...
          <div className="articles__details col-lg-9 col-md-12 col-sm-12">
            ...
            <div className="articles__details--Author row">
              ...
              <div className="articlesBtn col-lg-6 col-md-6 col-sm-12">
                ...
                <div className="more">
                  <button type="submit" className="read-more fa">Read more</button>
                </div>
              </div>
